...
--AGREGANDO FUNCIONES POR ROL
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(1, 'ABM de Rol', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(2, 'Login y Seguridad', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(3, 'ABM de Usuario', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(4, 'ABM de Cliente', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(5, 'ABM de Cuenta', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(6, 'Depósitos', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(7, 'Retiro de Efectivo', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(8, 'Transferencia entre Cuentas', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(9, 'Facturación de Costos', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(10, 'Consulta de Saldos', 1)
INSERT INTO BOBBY_TABLES.FUNCIONES_POR_ROL
VALUES(11, 'Listado Estadístico', 1)
...
DROP TABLE BOBBY_TABLES.AUXILIAR --ELIMINO LA TABLA YA QUE NO TIENE MÁS UTILIDAD
...
--BAJA CLIENTES
GO
CREATE PROCEDURE BAJA_CLIENTE(@ID INT) AS --TODO ¿DAR DE BAJA USUARIO Y/O PERSONA?
BEGIN
...
--GET CLIENTES
GO
CREATE FUNCTION GET_CLIENTE(@ID INT) RETURNS @CLIENTE TABLE( --TODO VER SI SE NECESITA ESTO
	PER_ID INT,
	TIPO_DOC INT,
	NUMERO_DOC NUMERIC(10,0),
	NOMBRE VARCHAR(255),
...
--ALTA CUENTAS
GO
CREATE PROCEDURE AGREGAR_CUENTA(@USUARIO INT,@MONEDA INT,@PAIS INT,@TIPO INT,@FECHA_ALTA DATE) AS --TODO FECHA_EXPIRACION?
BEGIN
