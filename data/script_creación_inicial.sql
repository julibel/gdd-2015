...
INSERT INTO BOBBY_TABLES.FUNCIONALIDADES
VALUES(9, 'Facturación de Costos')
INSERT INTO BOBBY_TABLES.FUNCIONALIDADES
VALUES(10, 'Consulta de Saldos')
INSERT INTO BOBBY_TABLES.FUNCIONALIDADES
VALUES(11, 'Listado Estadístico')
...
GO
CREATE PROCEDURE BOBBY_TABLES.MODIFICAR_CUENTA(@ID NUMERIC(18,0),@USUARIO INT,@MONEDA INT,@PAIS INT,@TIPO INT,@FECHA DATE) AS
BEGIN
	DECLARE @TIPO_ANTERIOR INT
...
GO
CREATE FUNCTION BOBBY_TABLES.CLIENTES_CON_CUENTAS_INHABILITADAS_POR_AUSENCIA_DE_PAGO(@FECHA_INICIO DATE, @FECHA_FIN DATE) RETURNS @CLIENTES TABLE(
	PER_ID INT,
	NOMBRE VARCHAR(255),
	APELLIDO VARCHAR(255),
	CUENTAS INT,
...
GO
CREATE FUNCTION BOBBY_TABLES.CLIENTES_CON_MAS_COMISIONES_FACTURADAS(@FECHA_INICIO DATE, @FECHA_FIN DATE) RETURNS @CLIENTES TABLE(
	PER_ID INT,
	NOMBRE VARCHAR(255),
	APELLIDO VARCHAR(255),
...
GO
CREATE FUNCTION BOBBY_TABLES.CLIENTES_CON_MAYOR_TRANSFERENCIA_ENTRE_CUENTAS_PROPIAS(@FECHA_INICIO DATE, @FECHA_FIN DATE) RETURNS @CLIENTES TABLE(
	PER_ID INT,
	NOMBRE VARCHAR(255),
	APELLIDO VARCHAR(255),
...
GO
CREATE FUNCTION BOBBY_TABLES.PAISES_CON_MAS_MOVIMIENTOS(@FECHA_INICIO DATE, @FECHA_FIN DATE) RETURNS @PAISES TABLE(
	PAI_ID INT,
	NOMBRE VARCHAR(250),
...
GO
CREATE FUNCTION BOBBY_TABLES.FACTURADO_PARA_CADA_TIPO(@FECHA_INICIO DATE, @FECHA_FIN DATE) RETURNS @TIPOS_CUENTA TABLE(
	TIP_ID INT,
	NOMBRE VARCHAR(9),
	FACTURADO FLOAT
) AS
...
GO
--PRUEBA DE LISTAS POR PARÁMETROS
