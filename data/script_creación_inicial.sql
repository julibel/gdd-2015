...
GO
CREATE PROCEDURE BOBBY_TABLES.GET_ROL(@NOMBRE VARCHAR(50)) AS
BEGIN
...
BEGIN
	...
	INSERT INTO BOBBY_TABLES.TARJETAS
	VALUES(@CLIENTE, BOBBY_TABLES.ENCRIPTAR_TARJETA(@NUMERO), BOBBY_TABLES.ULTIMOS_4_DIGITOS(@NUMERO), HASHBYTES('SHA1',@CODIGO_SEG), @EMISOR_ID, @FECHA_EMISION, @FECHA_VENCIMIENTO)
END
