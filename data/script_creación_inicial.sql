...
BEGIN
	SELECT TAR_ID, CLIENTE, NOMBRE, '************' + LIMPIO AS NUMERO_TARJETA, FECHA_EMISION, FECHA_VENCIMIENTO FROM BOBBY_TABLES.TARJETAS, BOBBY_TABLES.EMISORES
	WHERE /*@ID*/107 = CLIENTE AND
		  EMISOR = EMI_ID
END
