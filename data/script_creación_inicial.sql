...
SELECT OPERACION, CUENTA_DESTINO, IMPORTE FROM BOBBY_TABLES.#AUXILIAR
...
select * from BOBBY_TABLES.CLIENTES where NOMBRE like 'Ilva'

select * from BOBBY_TABLES.CHEQUES
select * from BOBBY_TABLES.RETIROS_EFECTIVO
select * from BOBBY_TABLES.OPERACIONES