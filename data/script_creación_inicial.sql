...
VALUES('martin', CONVERT(VARBINARY(32),'e6b87050bfcb8143fcb8db0170a4dc9ed00d904ddd3e2a4ad1b1e8dc0fdc9be7'),GETDATE(), '¿Cuál es tu color preferido?', CONVERT(VARBINARY(32),'9e3fc69d0d9cdcd532456f53c9c12909328ffeaab9046874a240c51fb813322d'))
INSERT INTO BOBBY_TABLES.ROLES_POR_USUARIO
VALUES(1,@@IDENTITY)
...
BEGIN
	...
	SET @HASH_RESP = CONVERT(VARBINARY(32), @RESPUESTA)
...
BEGIN
	...
	SELECT TOP 5 P.CLI_ID AS ID_Cliente, P.NOMBRE AS Nombre, P.APELLIDO AS Apellido, COUNT(C.CUE_ID) AS Cuentas, SUM(F.IMPORTE) AS Deuda_Total FROM BOBBY_TABLES.CLIENTES P, BOBBY_TABLES.CUENTAS C, BOBBY_TABLES.FACTURAS F, BOBBY_TABLES.ESTADOS_CUENTA E
...
BEGIN
	...
	SELECT TOP 5 P.CLI_ID AS ID_Cliente, P.NOMBRE AS Nombre, P.APELLIDO AS Apellido, COUNT(T.TRA_ID) AS Cantidad_Comisiones, SUM(F.IMPORTE) AS Total_Comisiones FROM BOBBY_TABLES.CLIENTES P, BOBBY_TABLES.CUENTAS C, BOBBY_TABLES.TRANSFERENCIAS T, BOBBY_TABLES.OPERACIONES O, BOBBY_TABLES.FACTURAS F
	WHERE P.CLI_ID = C.CLIENTE AND
...
BEGIN
	...
	SELECT TOP 5 T.NOMBRE AS Tipo, SUM(F.IMPORTE) AS Facturado FROM BOBBY_TABLES.TIPOS_CUENTA T, BOBBY_TABLES.FACTURAS F
