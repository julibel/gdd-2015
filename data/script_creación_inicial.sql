...
GO
CREATE PROCEDURE BOBBY_TABLES.GET_COSTOS_TIPOS(@ID INT) AS
BEGIN
	SELECT COSTO_MANTENIMIENTO, COSTO_TRANSACCION FROM BOBBY_TABLES.TIPOS_CUENTA
	WHERE TIP_ID = @ID
END
