...
--MODIFICIÓN TARJETAS
GO
CREATE PROCEDURE BOBBY_TABLES.MODIFICAR_TARJETA(@ID INT,@NUMERO NUMERIC(16,0),@CLIENTE INT,@TITULAR VARCHAR(50),
	@CODIGO_SEG NUMERIC(4,0),@EMISOR VARCHAR(60),@FECHA_EMISION_APP VARCHAR(30),@FECHA_VENCIMIENTO_APP VARCHAR(30)) AS
BEGIN --TRANSACTION
	DECLARE @EMISOR_ID INT, @FECHA_EMISION DATETIME, @FECHA_VENCIMIENTO DATETIME
	SET @FECHA_EMISION = CONVERT(DATETIME, @FECHA_EMISION_APP)
	SET @FECHA_VENCIMIENTO = CONVERT(DATETIME, @FECHA_VENCIMIENTO_APP)
