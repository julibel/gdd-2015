...
INSERT INTO USUARIOS(USERNAME, PASSWORD, FECHA_ALTA)
...
INSERT INTO PERSONAS(TIPO_DOC, NUMERO_DOC, NOMBRE, APELLIDO, PAIS, CALLE, NUMERO_DOM, PISO, DEPTO, FECHA_NACIMIENTO, MAIL, USUARIO)
SELECT DISTINCT M.Cli_Tipo_Doc_Cod, M.Cli_Nro_Doc, M.Cli_Nombre, M.Cli_Apellido, M.Cli_Pais_Codigo, M.Cli_Dom_Calle, M.Cli_Dom_Nro, M.Cli_Dom_Piso, M.Cli_Dom_Depto, M.Cli_Fecha_Nac, M.Cli_Mail, U.USU_ID FROM gd_esquema.Maestra M, USUARIOS U
