...
INSERT INTO BOBBY_TABLES.TIPOS_CUENTA
VALUES('Bronce', 200, 50, 60)
INSERT INTO BOBBY_TABLES.TIPOS_CUENTA
VALUES('Plata', 350, 15, 90)
INSERT INTO BOBBY_TABLES.TIPOS_CUENTA
VALUES('Oro', 400, 5, 120)
...
BEGIN
	SELECT @CUENTA AS 'Cuenta Destino', C.CUE_ID AS 'Cuenta Origen', P.NOMBRE + ' ' + P.APELLIDO AS Cliente, O.IMPORTE AS Importe, T.COSTO AS Costo, M.NOMBRE AS Moneda, O.FECHA AS Fecha FROM BOBBY_TABLES.OPERACIONES O, BOBBY_TABLES.TRANSFERENCIAS T, BOBBY_TABLES.CUENTAS C, BOBBY_TABLES.CLIENTES P, BOBBY_TABLES.MONEDAS M
	WHERE O.CUENTA = @CUENTA AND
		  ...
		  O.MONEDA = M.MON_ID
	UNION
	SELECT C.CUE_ID AS 'Cuenta Destino', @CUENTA AS 'Cuenta Origen', P.NOMBRE + ' ' + P.APELLIDO AS Cliente, O.IMPORTE AS Importe, T.COSTO AS Costo, M.NOMBRE AS Moneda, O.FECHA AS Fecha FROM BOBBY_TABLES.OPERACIONES O, BOBBY_TABLES.TRANSFERENCIAS T, BOBBY_TABLES.CUENTAS C, BOBBY_TABLES.CLIENTES P, BOBBY_TABLES.MONEDAS M
