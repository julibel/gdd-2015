...
--GET ID TARJETAS
GO
CREATE PROCEDURE BOBBY_TABLES.GET_ID_TARJETA(@ENCRIPT VARCHAR(40),@ULTIMOS VARCHAR(4),@COD_SEG VARCHAR(40)) AS
BEGIN
	...
	SELECT @ID = TAR_ID FROM BOBBY_TABLES.TARJETAS--, BOBBY_TABLES.USUARIOS, BOBBY_TABLES.CLIENTES
	WHERE --USU_ID = USUARIO AND
		  --CLIENTE = CLI_ID AND
		  ENCRIPTADO = @HASH_ENC AND
		  LIMPIO = @LIMPIO AND
		  COD_SEGURIDAD = @HASH_COD
