...
WHERE Trans_Importe > 0 AND Factura_Numero IS NOT NULL
...
BEGIN --TRANSACTION
	...
	END TRY
	BEGIN CATCH
		--SI HAY ERROR QUIERE DECIR QUE YA EXISTÍA ESA RELACIÓN (NO HAY CAMBIO DE ESTADO)
	END	CATCH
END --COMMIT
...
SELECT * FROM BOBBY_TABLES.CLIENTES, BOBBY_TABLES.PAISES
where PAIS=PAI_ID
